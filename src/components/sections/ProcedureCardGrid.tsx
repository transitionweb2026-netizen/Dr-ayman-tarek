...
function ProcedureCard({ item, onSelect }: { item: ProcedureCardItem; onSelect: () => void }) {
  return (
    <GlassCard as="article" radius="2xl" className="group flex flex-col overflow-hidden text-left rtl:text-right">
      <button onClick={onSelect} className="flex flex-col text-left rtl:text-right">
