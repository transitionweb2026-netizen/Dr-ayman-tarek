    ...
    Tables: {
      ...
      site_settings: {
        Row: {
          ...
          default_twitter_image_media_id: string | null;
          address_street_en: string | null;
          address_street_ar: string | null;
          address_city_en: string | null;
          address_city_ar: string | null;
          address_region_en: string | null;
          address_region_ar: string | null;
          address_postal_code: string | null;
          address_country_en: string | null;
          address_country_ar: string | null;
          geo_latitude: number | null;
          geo_longitude: number | null;
          default_title_en: string | null;
          default_title_ar: string | null;
          title_template_en: string | null;
          title_template_ar: string | null;
          default_description_en: string | null;
          default_description_ar: string | null;
